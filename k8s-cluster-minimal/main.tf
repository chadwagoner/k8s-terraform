...
resource "digitalocean_droplet" "k8s-master-1001" {
  ...
  ssh_keys   = [
    digitalocean_ssh_key.k8s-ssh.fingerprint
  ]
}
...
resource "digitalocean_droplet" "k8s-worker-1001" {
  ...
  volume_ids = [
    digitalocean_volume.k8s-worker-1001-vol1.id
  ]
}
...
resource "digitalocean_droplet" "k8s-worker-1002" {
  ...
  volume_ids = [
    digitalocean_volume.k8s-worker-1002-vol1.id
  ]
}
...
resource "digitalocean_droplet" "k8s-worker-1003" {
  ...
  volume_ids = [
    digitalocean_volume.k8s-worker-1003-vol1.id
  ]
}
